...
void Rain_Animation(lv_obj_t * TargetObject, int delay)
{
    ...
    lv_anim_set_values(&PropertyAnimation_0, 0, 83);
    lv_anim_set_path_cb(&PropertyAnimation_0, lv_anim_path_linear);
    lv_anim_set_delay(&PropertyAnimation_0, delay + 0);
    lv_anim_set_playback_time(&PropertyAnimation_0, 0);
    lv_anim_set_playback_delay(&PropertyAnimation_0, 0);
...
void ui_event_Time_Group_Time_Group(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_Time_Screen, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0);
    }
}
void ui_event_Temperature_Group_Temperature_Group(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_Thermostat_Screen, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0);
    }
}
void ui_event_Weather_Group_Weather_Group(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_Weather_Screen, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0);
    }
}
void ui_event_Settings_Group_Settings_Dark(lv_event_t * e)
{
...
void ui_event_Footer2_Home_Button(lv_event_t * e)
{
    ...
    lv_obj_t * target = lv_event_get_target(e);
    if(event_code == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_Home_Screen, LV_SCR_LOAD_ANIM_FADE_ON, 100, 0);
    }
}
void ui_event_Settings_Group1_Settings_Dark(lv_event_t * e)
{
...
void ui_Home_Screen_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Time_Group, 390);
    ...
    lv_obj_set_height(ui_Temperature_Group, 390);
    ...
    lv_obj_set_height(ui_Weather_Group, 390);
...
void ui_Time_Screen_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Time_Group1, 390);
    lv_obj_set_width(ui_Time_Group1, lv_pct(40));
    ...
    lv_obj_set_height(ui_World_Time_Group, 390);
    ...
    lv_obj_set_flex_align(ui_World_Time_Group, LV_FLEX_ALIGN_SPACE_AROUND, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    ...
    lv_obj_set_style_pad_left(ui_World_Time_Group, 28, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(ui_World_Time_Group, 28, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui_World_Time_Group, 28, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(ui_World_Time_Group, 28, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_Weather_Screen_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Weather_Group1, 390);
    ...
    lv_obj_set_height(ui_Weather_Content_Group, 390);
...
void ui_Thermostat_Screen_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Weather_Content_Group1, 390);

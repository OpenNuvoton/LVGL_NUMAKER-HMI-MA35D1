...
lv_obj_t * ui_Footer_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_style_pad_column(cui_Footer, 12, LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t * ui_Temperature_Group_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_height(cui_Temperature_Group, 390);
    ...
    lv_obj_set_height(cui_Content, 390);
    lv_obj_set_width(cui_Content, lv_pct(100));
    ...
    lv_obj_set_width(cui_Thermostat_Arc, 240);
    lv_obj_set_height(cui_Thermostat_Arc, 240);
    ...
    lv_obj_set_style_arc_width(cui_Thermostat_Arc, 8, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_rounded(cui_Thermostat_Arc, true, LV_PART_MAIN | LV_STATE_DEFAULT);

    lv_obj_set_style_arc_width(cui_Thermostat_Arc, 8, LV_PART_INDICATOR | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_left(cui_Thermostat_Arc, 6, LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_right(cui_Thermostat_Arc, 6, LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(cui_Thermostat_Arc, 6, LV_PART_KNOB | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_bottom(cui_Thermostat_Arc, 6, LV_PART_KNOB | LV_STATE_DEFAULT);
    ...
    lv_obj_set_y(cui_Degree_Min, 26);
    ...
    lv_obj_set_y(cui_Degree_MAx, 26);
...
lv_obj_t * ui_Time_Group_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_height(cui_Time_Group, 390);
    ...
    lv_obj_set_width(cui_Clock_Group, 286);
    lv_obj_set_height(cui_Clock_Group, 278);
...
lv_obj_t * ui_Title_Number_Group_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_height(cui_Title_Number_Group, 55);
...
lv_obj_t * ui_WeatheGroupList_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_width(cui_Weather_City_Degree, lv_pct(50));
    ...
    lv_obj_set_width(cui_Degree_Grup, 130);
    ...
    lv_obj_set_flex_align(cui_Panel5, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER);
    ...
    lv_obj_set_style_pad_row(cui_Panel5, 10, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_pad_column(cui_Panel5, 16, LV_PART_MAIN | LV_STATE_DEFAULT);
...
lv_obj_t * ui_Weather_Group_create(lv_obj_t * comp_parent)
{
    ...
    lv_obj_set_height(cui_Weather_Group, 390);
    ...
    lv_obj_set_width(cui_Weather_Rain_Group, 230);
    lv_obj_set_height(cui_Weather_Rain_Group, 197);
    ...
    lv_obj_set_height(cui_Rain, 166);
    lv_obj_set_width(cui_Rain, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_x(cui_Rain, -10);
    lv_obj_set_y(cui_Rain, 30);
    lv_obj_set_align(cui_Rain, LV_ALIGN_BOTTOM_MID);
    ...
    lv_obj_set_height(cui_Rain1, 166);
    lv_obj_set_width(cui_Rain1, LV_SIZE_CONTENT);   /// 1
    lv_obj_set_x(cui_Rain1, 0);
    lv_obj_set_y(cui_Rain1, 20);
    lv_obj_set_align(cui_Rain1, LV_ALIGN_BOTTOM_MID);
    ...
    lv_obj_set_height(cui_Title_Number_Group3, 58);
    lv_obj_set_width(cui_Title_Number_Group3, lv_pct(50));
    lv_obj_set_x(cui_Title_Number_Group3, 0);
    lv_obj_set_y(cui_Title_Number_Group3, 10);
    ...
    lv_obj_set_height(cui_Title_Number_Group4, 55);
    ...
    lv_obj_set_height(cui_Title_Number_Group5, 55);
    ...
    lv_obj_set_height(cui_Title_Number_Group6, 55);
